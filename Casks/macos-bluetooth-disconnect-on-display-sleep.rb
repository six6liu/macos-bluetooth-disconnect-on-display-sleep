cask "macos-bluetooth-disconnect-on-display-sleep" do
  version "1.0"
  ...
  desc "Disconnect a Bluetooth device when the macOS display sleeps; reconnect on wake"
  ...
  zap trash: [
    ...
    "~/Library/Saved Application State/com.apple.scripteditor.id.macos-bluetooth-disconnect-on-display-sleep.savedState",
  ]
end
